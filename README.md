...
A responsive personal portfolio website by **Bernard Orozco Ablog**, built as part of the MST Connect PH Full-Stack Web Development Bootcamp. The site introduces me as an aspiring full-stack web developer and showcases my current skills, projects, contact information, and professional links.

## Live Demo

[View Portfolio](https://bernzablog.github.io/capstone1/)

## Screenshot

> Add a homepage screenshot to your `images/` folder, then update the path below.

![Portfolio Homepage]9C:\Users\Asus\Documents\Ablog-fullstack-bootcamp\projects\capstone1\images\Screenshot1.png)
...
### Home / Hero
Introduces **Bernard Orozco Ablog** as an aspiring full-stack web developer and includes buttons for viewing projects and visiting GitHub.
...
```bash
git clone https://github.com/bernzablog/capstone1.git
cd capstone1
```
...
**Bernard Orozco Ablog**  
Aspiring Full-Stack Web Developer

### Professional Links

- GitHub: https://github.com/bernzablog
- LinkedIn: https://www.linkedin.com/in/bernard-ablog-4040751aa
